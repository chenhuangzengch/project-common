...
import net.xuele.common.exceptions.NotifyException;
...
/**
 * shaokun.zhi 新建于 2015/7/8 0004.
 */
public final class NotifyAssert {

    private NotifyAssert() {
    ...
    public static void isTrue(boolean expression, String message, String errorCode) {
        if (!expression) {
            throw new NotifyException(message, errorCode);
        }
    }
