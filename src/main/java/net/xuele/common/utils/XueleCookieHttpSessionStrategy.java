...
/**
 * session cookie管理器
 * zhihuan.cai 新建于 2015/7/7 0007.
 */
public final class XueleCookieHttpSessionStrategy implements MultiHttpSessionStrategy, HttpSessionManager {
    ...
    private Cookie createSessionCookie(HttpServletRequest request, Map<String, String> sessionIds) {
        ...
        sessionCookie.setDomain(".xuele.net");
    ...
    class MultiSessionHttpServletResponse extends HttpServletResponseWrapper {
        ...
        public String encodeRedirectURL(String url) {
            ...
            return XueleCookieHttpSessionStrategy.this.encodeURL(url, getCurrentSessionAlias(request));
        }
        ...
        public String encodeURL(String url) {
            ...
            return XueleCookieHttpSessionStrategy.this.encodeURL(url, alias);
        }
    }
